    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <Link
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-xl shadow-md shadow-blue-500/20 transition-all shrink-0"
        >
          ...
          {templates.map((tmpl) => (
            <div
              ...
              className={clsx(
                ...
                tmpl.isActive ? "border-blue-200 ring-1 ring-blue-500/20" : "border-slate-200 opacity-80 bg-slate-50/50"
              )}
            >
              <div className="space-y-3">
                ...
                <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 space-y-1 text-xs text-slate-600">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-blue-600">{tmpl.fields?.length || 0} zones</span>
                  </div>
                </div>
              </div>
